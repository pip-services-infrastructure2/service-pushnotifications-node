...
```javascript
{
    ...
    "dependencies": {
        ....
        "service-pushnotifications-node": "^1.0.0",
        ...
    }
}
```
...
var plugin = require('service-pushnotifications-node').PushNotificationsSenecaPlugin;
...
or by using [PushNotificationsSenecaClient](https://github.com/pip-services-infrastructure2/client-notification-node/NodeClientApiV1.md/#client_seneca)